...
class AuthenticationCon extends Component {
    ...
    signUpSuccessEmail = () => {
       ...
       fetch(`https://ec2-18-188-237-84.us-east-2.compute.amazonaws.com:8080/login?recipient=${email.recipient}&firstName=${email.firstName}&companyName=${email.companyName}&sender=${email.sender}&topic=${email.subject}&html=${email.html}&text=${email.text}&key=${this.props.rdxAuthState.sgKey}`) //query string url
